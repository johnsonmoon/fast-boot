...
public class ApplicationConfigurationUtils {
	...
	public static boolean checkConfigurationMin(ApplicationConfiguration applicationConfiguration) {
	...
	public static boolean checkConfigurationAll(ApplicationConfiguration applicationConfiguration) {
		if (applicationConfiguration == null) {
			logger.error("ApplicationConfiguration missing.");
			return false;
		}
